...
function inicializarComentarios() {
    ...
    containers.forEach(container => {  
        ...
        const colecao = container.getAttribute('data-collection') || 'analises'; // Default para 'analises' se não especificado
        ...
        // Constrói o caminho dinâmico com base na coleção e ID da notícia
...
<div class="container-comentarios-dinamico" data-noticia-id="123" data-collection="analises"></div>
<div class="container-comentarios-dinamico" data-noticia-id="456" data-collection="noticias"></div>
<div class="container-comentarios-dinamico" data-noticia-id="789" data-collection="reviews"></div>
